...
public class AllStudent extends javax.swing.JFrame implements ActionListener {
    public AllStudent() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father's Name", "Mother's Name", "Email -ID", "Address", "Collage Name", "Adhar Number", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 49, 650, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/backgroundmanage.jpg"))); // NOI18N
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == jButton1) {
            AllStudent.this.jButton1ActionPerformed(evt);
        }
